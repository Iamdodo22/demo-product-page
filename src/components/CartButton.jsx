...
const addToCart = () => {
  ...
  return (
    <div className='flex gap-2'>
        <span className='flex bg-blueGray5 gap-3 p-2 items-center font-semibold'>
        ...
        <button onClick={addToCart} className='bg-orange text-white flex py-1 px-4 rounded-lg items-center hover:opacity-25'>
